...
enum class DOTA_ITEM_STATE : unsigned long
{
...
enum class ERoshanSpawnPhase : unsigned long
{
...
enum class PortraitSoundMode_t : signed long
{
...
{
	RESOURCE_INPUT_DEPENDENCY_NOFLAG = 0,
	RESOURCE_INPUT_DEPENDENCY_OPTIONAL = 1,
	RESOURCE_INPUT_DEPENDENCY_EXISTS = 2,
	RESOURCE_INPUT_DEPENDENCY_GAME_FILE = 4,
};
...
enum class eEconItemOrigin : signed long
{
	...
	kEconItemOrigin_Max = 35,
};

enum class eLiteralHandType : unsigned long
{
	LITERAL_HAND_TYPE_UNKNOWN = 0,
	LITERAL_HAND_TYPE_RIGHT = 1,
	LITERAL_HAND_TYPE_LEFT = 2,
};
...
enum class interactions_t : signed long
{
	INTERACTION_NONE = -1,
	INTERACTION_CLIP_TO_PISTOL = 0,
	INTERACTION_CLIP_TO_ENERGYGUN = 1,
	INTERACTION_ENERGYGUN_TO_GRENADE = 2,
	INTERACTION_ENERGYGUN_TO_WEAPONMODULE = 3,
	NUM_HAND_INTERACTIONS = 4,
};
